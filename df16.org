...
** Overview
*** Description
Make customer service your competitive advantage with hundreds of solutions from AppExchange. Join us to hear how experts use apps to engage with customers in new ways - through, for example, increased agent productivity, better field service, and surveys. You'll walk away with actionable tips and a list of top service apps (both paid and free) that you can easily deploy with just a few clicks.
** Memo
