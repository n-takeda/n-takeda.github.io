...
michelle mere business process director
- sucess model
...
　　Globalで30%は使ってる。日本人中では50%は使ってる。意味はある。Trailheadについては、あんまデータとってないからヘビーに使ってるとか使ってないとかまではわからん
    ここで喋ってるユーザのユースケースは、adminだけで(developer委託せずに）つかってる例ですぜ
** HQ 日本職員 panel
- direction: bannai
- sadahiro suzuki (ntt software)
- ryuji osawa
...
- 「engeneering側が拒否することもあるんだよ。思われてるほどPMは強くないんだよ」
